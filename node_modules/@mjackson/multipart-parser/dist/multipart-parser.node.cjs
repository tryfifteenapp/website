...
__export(multipart_parser_node_exports, {
  ...
  parseMultipartStream: () => parseMultipartStream2
});
...
async function* parseMultipartStream2(stream, options) {
  yield* parseMultipartStream(import_node_stream.Readable.toWeb(stream), options);
}
...
//# sourceMappingURL=multipart-parser.node.cjs.map
